...
var phraseArray = [ " I see trouble ahead. Gather your things and get on the next train.",
                    ...
                    " Look out for the number 2, it will be important today.",
                    " The fortune you seek is in another tweet.",
                    " The next directions you are given will be wrong. Follow them anyway.",
                    " Start answering those unknown numbers. One of them will be an opportunity for friendship.",
                    " Wait for a day when ink is spilled. Your fate will be left with the stains.",
                    " Actions speak louder than tweets.",
                    " Buy chips on the way home. We promise it will be the best idea.",
                    " Tomorrow you will find yourself in anger, sing the alphabet.",
                    " Try again.",
                    " Fortune not found. Retry.",
                    " Ignore all previous fortunes.",
                    " Follow the woman in white, she will bring you luck (and onto the wrong train).",
                    " A man with a smashed phone screen will bring you good luck.",
                    " A woman with a smashed phone screen will bring you good luck.",
                    " I would like to add you to my professional network on Linkedin",
                    " Someone has Googled you recently.",
                    " Beware the person that tells you to Keep Calm and Carry On",
                    " If a ginger cat will cross your path, your next cup of tea will be excellent.",
                    " Next time, order the ",
                    " I spy with my little eye, a very good dog will appear in your day.",
